...
//#cgo darwin LDFLAGS: -L/usr/local/lib -L/opt/homebrew/opt/openssl@3 -ltdjson_static -ltdjson_private -ltdclient -ltdcore -ltdapi -ltdactor -ltddb -ltdsqlite -ltdnet -ltdutils -lstdc++ -lssl -lcrypto -ldl -lz -lm
